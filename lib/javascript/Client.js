...
function submoduletest(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.foo = function (a, _callback, _errorCallback) {
        if (typeof a === 'function')
            throw 'Argument a can not be a function';
        ...
        return json_call_ajax(_url, "submoduletest.foo",
            [a], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "submoduletest.status",
